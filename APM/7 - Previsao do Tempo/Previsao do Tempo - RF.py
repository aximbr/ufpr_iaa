...
print(' ')
print('###########################')
print('EXPERIMENTO RF - Previsão do Tempo')
print(' ')
...
print(' ')
print('RF - Previsão do Tempo - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/7 - Previsao do Tempo/Previsao do Tempo - Novos Casos - Predicoes em Python RF.csv", index=False)
print("\nPredições salvas em 'Previsao do Tempo - Novos Casos - Predicoes em Python RF.csv'")
