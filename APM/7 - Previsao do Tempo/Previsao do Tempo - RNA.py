...
print(' ')
print('###########################')
print('EXPERIMENTO RNA - Previsão do Tempo')
print(' ')
...
# plt.xlabel('Previsto')
# plt.ylabel('Corretos')
# plt.title('Matrix de confusão - RNA')
...
print(' ')
print('RNA - Previsão do Tempo - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/7 - Previsao do Tempo/Previsao do Tempo - Novos Casos - Predicoes em Python RNA.csv", index=False)
print("\nPredições salvas em 'Previsao do Tempo - Novos Casos - Predicoes em Python RNA.csv'")
