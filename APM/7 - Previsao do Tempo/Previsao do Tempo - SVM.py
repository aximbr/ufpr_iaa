...
#grid = GridSearchCV(SVC(), param_grid, n_jobs= -1, cv=9)
grid = GridSearchCV(SVC(), param_grid, n_jobs= -1)
grid.fit(X_train, y_train)

print(' ')
print('###########################')
print('EXPERIMENTO SVM - Previsão do Tempo')
print(' ')
...
print(' ')
print('SVM - Previsão do Tempo - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/7 - Previsao do Tempo/Previsao do Tempo - Novos Casos - Predicoes em Python SVM.csv", index=False)
print("\nPredições salvas em 'Previsao do Tempo - Novos Casos - Predicoes em Python SVM.csv'")
