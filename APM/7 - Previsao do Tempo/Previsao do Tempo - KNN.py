...
df = pd.read_csv('/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/7 - Previsao do Tempo/Previsao do Tempo - Dados.csv',sep=',')
#df = df.drop('num', axis = 1)


print(' ')
print('###################')
print('Conteúdo do arquivo - Previsão do Tempo')
print(df.head())
...
grid = GridSearchCV(KNeighborsClassifier(), param_grid, n_jobs= -1, cv=9)
grid.fit(X_train, y_train)

print(' ')
print('###########################')
print('EXPERIMENTO KNN - Previsão do Tempo')
print(' ')
...
print(' ')
print('KNN - Previsão do Tempo - Matriz de Confusão')
print(conf_matrix)
...
dados_novos_path = "/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/7 - Previsao do Tempo/Previsao do Tempo - Novos Casos - Para Python.csv"  # CSV SEM a variável alvo
...
dados_novos['Ceu'] = le.fit_transform(dados_novos['Ceu'])
dados_novos['Temperatura'] = le.fit_transform(dados_novos['Temperatura'])
dados_novos['Umidade'] = le.fit_transform(dados_novos['Umidade'])
dados_novos['Vento'] = le.fit_transform(dados_novos['Vento'])
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/7 - Previsao do Tempo/Previsao do Tempo - Novos Casos - Predicoes em Python KNN.csv", index=False)
print("\nPredições salvas em 'Previsao do Tempo - Novos Casos - Predicoes em Python KNN.csv'")
