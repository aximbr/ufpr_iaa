...
df = pd.read_csv('/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/4 - Banco/Banco - Dados.csv',sep=',')
#df = df.drop('num', axis = 1)

#print(df.head())
print(' ')
print('###################')
print('Conteúdo do arquivo - Banco')
print(df.head())
...
print(' ')
print('KNN - Banco - Matriz de Confusão')
print(conf_matrix)
...
dados_novos_path = "/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/4 - Banco/Banco - Novos Casos - Para Python.csv"  # CSV SEM a variável alvo
...
##############################################
# Transforma as variáveis discretas em 0,1,2
dados_novos['job'] = le.fit_transform(dados_novos['job'])
dados_novos['marital'] = le.fit_transform(dados_novos['marital'])
dados_novos['education'] = le.fit_transform(dados_novos['education'])
dados_novos['default'] = le.fit_transform(dados_novos['default'])
dados_novos['balance'] = le.fit_transform(dados_novos['balance'])
dados_novos['housing'] = le.fit_transform(dados_novos['housing'])
dados_novos['loan'] = le.fit_transform(dados_novos['loan'])
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/4 - Banco/Banco - Novos Casos - Predicoes em Python KNN.csv", index=False)
print("\nPredições salvas em 'Banco - Novos Casos - Predicoes em Python KNN.csv'")
