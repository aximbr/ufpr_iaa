...
print(' ')
print('SVM - Banco - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/4 - Banco/Banco - Novos Casos - Predicoes em Python SVM.csv", index=False)
print("\nPredições salvas em 'Banco - Novos Casos - Predicoes em Python SVM.csv'")
