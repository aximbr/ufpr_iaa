...
k_range = list(range(2, 20, 2))  #de 2 até 20 de 2 em 2
param_grid = {
    'n_neighbors': k_range,
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/6 - Veiculos/Veiculos - Novos Casos - Predicoes em Python KNN.csv", index=False)
