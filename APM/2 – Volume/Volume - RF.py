...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/2 – Volume/Volume - Novos Casos - Predicoes em Python RF.csv", index=False)
print("\nVolume - Novos Casos - Predicoes em Python RF.csv'")
