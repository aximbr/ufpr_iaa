...
metrics_model = get_regression_metrics(y_test, y_pred,"SVR")
results.append(metrics_model)

print(' ')
print('###########################')
print('EXPERIMENTO SVM - Volume')
print(' ')
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/2 – Volume/Volume - Novos Casos - Predicoes em Python SVM.csv", index=False)
print("\nVolume - Novos Casos - Predicoes em Python SVM.csv'")
