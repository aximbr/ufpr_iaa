...
df = pd.read_csv('/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/2 – Volume/Volume - Dados.csv',sep=',')
#df = df.drop('num', axis = 1)
results = []

print(' ')
print('###################')
print('Conteúdo do arquivo - Volume')
print(df.head())
...
df['PROJETO'] = le.fit_transform(df['PROJETO'])
df['CLONE'] = le.fit_transform(df['CLONE'])
...
metrics_model = get_regression_metrics(y_test, y_pred,"MLPRegressor")
results.append(metrics_model)


print(' ')
print('###########################')
print('EXPERIMENTO RNA - Volume')
print(' ')
...
dados_novos_path = "/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/2 – Volume/Volume - Novos Casos - Para Python.csv"  # CSV SEM a variável alvo
...
# Discretiza as variáveis com domínio
dados_novos['PROJETO'] = le.fit_transform(dados_novos['PROJETO'])
dados_novos['CLONE'] = le.fit_transform(dados_novos['CLONE'])
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/2 – Volume/Volume - Novos Casos - Predicoes em Python RNA.csv", index=False)
print("\nVolume - Novos Casos - Predicoes em Python RNA.csv'")
