...
print(' ')
print('RNA - IR - Matriz de Confusão')
print(conf_matrix)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/8 - Imposto de Renda/IR - Novos Casos - Predicoes em Python RNA.csv", index=False)
print("\nPredições salvas em 'IR - Novos Casos - Predicoes em Python RNA.csv'")
