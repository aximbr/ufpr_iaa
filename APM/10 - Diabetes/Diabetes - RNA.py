...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/10 - Diabetes/Diabetes - Novos Casos - Predicoes em Python RNA.csv", index=False)
print("\nPredições salvas em 'Diabetes - Novos Casos - Predicoes em Python RNA.csv'")
