...
print(' ')
print('###########################')
print('EXPERIMENTO RF - Alunos - HOLD-OUT')

# Treinar Random Forest Hold-out
...
metrics_model = get_regression_metrics(y_test, y_pred,"RandomForestRegressor", grid.best_estimator_)
results.append(metrics_model)


print(' ')
print('###########################')
print('EXPERIMENTO RF - Alunos - CV')
print(' ')
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/3 - Alunos/Alunos - Novos Casos - Predicoes em Python RF.csv", index=False)
print("\nAlunos - Novos Casos - Predicoes em Python RF.csv'")
