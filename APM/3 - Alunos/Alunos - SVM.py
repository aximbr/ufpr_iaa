...
print(' ')
print('###########################')
print('EXPERIMENTO SVM - Alunos - HOLD OUT')
...
print(' ')
print('###########################')
print('EXPERIMENTO SVM - Alunos - CV')
print(' ')
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/3 - Alunos/Alunos - Novos Casos - Predicoes em Python SVM.csv", index=False)
print("\nAlunos - Novos Casos - Predicoes em Python SVM.csv'")
