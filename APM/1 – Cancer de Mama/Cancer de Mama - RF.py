...
dados_novos_path = "Cancer de Mama - Novos Casos - Para Python.csv"  # sem a variável alvo
...
dados_novos.to_csv("Cancer de Mama - Novos Casos - Predicoes em Python RF.csv", index=False)
