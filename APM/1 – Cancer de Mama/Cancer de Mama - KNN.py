...
df = pd.read_csv('Cancer de Mama - Dados.csv',sep=',')
...
dados_novos_path = "Cancer de Mama - Novos Casos - Para Python.csv"  # CSV sem a variável alvo
...
dados_novos.to_csv("Cancer de Mama - Novos Casos - Predicoes em Python KNN.csv", index=False)
