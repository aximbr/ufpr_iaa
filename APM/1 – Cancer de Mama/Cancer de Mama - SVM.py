...
print(' ')
print('###########################')
print('EXPERIMENTO SVM - Câncer de Mama - HOLD-OUT')

# 3. Criar pipeline com normalização e SVM
pipeline = make_pipeline(
    StandardScaler(),
    SVC(
        kernel='rbf',     # kernel radial (padrão)
...
print(' ')
print('SVM - Câncer de Mama - Matriz de Confusão - HOLD OUT')
...
print(' ')
print('###########################')
print('EXPERIMENTO SVM - Cancer de Mama - CV')
print(' ')
...
print(' ')
print('SVM - Cancer de Mama - Matriz de Confusão - CV')
print(conf_matrix)
...
dados_novos_path = "/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Para Python.csv"  # CSV sem variável alvo
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/1 – Cancer de Mama/Cancer de Mama - Novos Casos - Predicoes em Python SVM.csv", index=False)

# Exibe o resultado
print("Predições realizadas com sucesso.")
print(dados_novos[['predicao']])
print("Arquivo salvo como 'Cancer de Mama - Novos Casos - Predicoes em Python SVM.csv'")
