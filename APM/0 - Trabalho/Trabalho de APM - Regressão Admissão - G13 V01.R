...
DF_CSV<-"Admissao - Dados.csv"
DF_NOVOS_CASOS<-"Admissao - Novos Casos.csv"
CSV_NOVA_PRED <- "resultado_predicao_admissao.csv"
DEL_COLUNA<-"num"
...
### Faz a predição e mostra a matriz de confusão
resultados[[length(resultados)+1]] <-avaliar_modelo("RNA Hold-out", modelo, teste, y_teste)
...
### Faz a predição e mostra a matriz de confusão
resultados[[length(resultados)+1]] <-avaliar_modelo("RNA Cross Validation", modelo, teste, y_teste)
...
### Faz a predição e mostra a matriz de confusão
resultados[[length(resultados)+1]] <- avaliar_modelo("SVM Hold-out", modelo, teste, y_teste)
...
### Faz a predição e mostra a matriz de confusão
resultados[[length(resultados)+1]] <- avaliar_modelo("SVM Cross-Validation", modelo, teste, y_teste)
...
### Faz a predição e mostra a matriz de confusão
resultados[[length(resultados)+1]] <- avaliar_modelo("RF Hold-out", modelo, teste, y_teste)
...
### Faz a predição e mostra a matriz de confusão
resultados[[length(resultados)+1]] <- avaliar_modelo("RF Cross-Validation", modelo, teste, y_teste)
