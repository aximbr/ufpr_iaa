...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/5 - Biomassa/Biomassa - Novos Casos - Predicoes em Python KNN.csv", index=False)
print("\nPredições salvas em '/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/5 - Biomassa/Biomassa - Novos Casos - Predicoes em Python KNN.csv'")
