...
grid = GridSearchCV(MLPRegressor(), param_grid, refit=True, n_jobs=-1,cv=10)
...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/5 - Biomassa/Biomassa - Novos Casos - Predicoes em Python RNA.csv", index=False)
print("\nPredições salvas em '/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/5 - Biomassa/Biomassa - Novos Casos - Predicoes em Python RNA.csv'")
