...
dados_novos.to_csv("/Users/jaimewojciechowski/Dropbox/Jaime/AA-UFPR/EspecializacaoIAA2026/Praticas Python/9 - Admissao/Admissao - Novos Casos - Predicoes em Python KNN.csv", index=False)
